...
test('publisher workflow wiring', () => {
  ...
  assert.ok(publisherHome.includes('publishers.course.categoryIds'))
  assert.ok(publisherHome.includes('publisher-course-categories'))
  assert.ok(publisherHome.includes('publishers.course.tags'))
  assert.ok(publisherHome.includes('publisher-course-tags'))
  assert.ok(publisherHome.includes('publishers.course.previewLessonId'))
  ...
  assert.ok(publisherHome.includes('publisher-validation-summary'))
  assert.ok(publisherHome.includes('publisher-validation-errors'))
  assert.ok(publisherHome.includes('publisher-validation-warnings'))
  assert.ok(publisherHome.includes('publishers.validation.title'))
  assert.ok(publisherHome.includes('publishers.validation.publishBlocked'))
  assert.ok(publisherHome.includes('disabled={hasValidationErrors}'))
  ...
  assert.ok(publisherHome.includes('publishers.exercise.typeReordering'))
  ...
  assert.ok(publisherHome.includes('publisher-reordering-item-text'))
  ...
  assert.ok(publisherUtils.includes('languageCode'))
  assert.ok(publisherUtils.includes('categoryIds'))
  assert.ok(publisherUtils.includes('tags'))
  assert.ok(publisherUtils.includes('previewLessonId'))
  assert.ok(publisherUtils.includes('reindexMultipleChoiceChoices'))
  assert.ok(publisherUtils.includes('reindexReorderingItems'))
  assert.ok(publisherUtils.includes('fillInBlank'))
  assert.ok(publisherUtils.includes('multipleChoice'))
  assert.ok(publisherUtils.includes('reordering'))
